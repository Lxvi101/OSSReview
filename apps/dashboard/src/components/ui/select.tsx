...
/**
 * Native <select> styled like shadcn — no Radix dropdown wiring needed.
 * Good enough for a config form; we can swap in a Radix-based combobox
 * later if we add things like search-in-select.
 */
